...
public class ReduceImage {
    ...
    public static void reduceImg(Image src, String imgDist, int widthDist,
                                 int heightDist) throws ImagingOpException, IOException {
        File destFile = new File(imgDist);
        if (!destFile.getParentFile().exists()) {
        ...
        if (widthDist <= 0 || heightDist <= 0) {
            throw new ImagingOpException("缩略图高宽不能等于小于0");
        }
    ...
    public static void main(String[] args) {
        ...
        String imgDist = "F:/result/43502_1_ss7.jpg";
        ReduceImage.reduceImg(imageSrc, imgDist, 110);
