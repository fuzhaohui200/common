...
class GwoyeuRomatzyhTranslator {
     ...
     * <p/>
     * <i>Should be removed if new xPath parser supporting tag name with
     * number.</i>
     */
    ...
    static String convertHanyuPinyinToGwoyeuRomatzyh(String hanyuPinyinStr) {
        ...
        try {
            ...
            Document pinyinToGwoyeuMappingDoc = GwoyeuRomatzyhResource
                    .getInstance().getPinyinToGwoyeuMappingDoc();

            Element hanyuNode = pinyinToGwoyeuMappingDoc
                    .xpathSelectElement(xpathQuery1);
            ...
            if (null != hanyuNode) {
                ...
                String xpathQuery2 = "../"
                        ...
                        + "/text()";
                String targetPinyinStrWithoutToneNumber = hanyuNode
                        .xpathSelectString(xpathQuery2);
