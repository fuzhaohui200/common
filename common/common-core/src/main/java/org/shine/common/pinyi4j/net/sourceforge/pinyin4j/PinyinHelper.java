...
package org.shine.common.pinyi4j.net.sourceforge.pinyin4j;
...
public class PinyinHelper {
    ...
    static private String[] getFormattedHanyuPinyinStringArray(char ch,
        ...
        if (null != pinyinStrArray) {
            ...
            for (int i = 0; i < pinyinStrArray.length; i++) {
                pinyinStrArray[i] = PinyinFormatter.formatHanyuPinyin(
                        pinyinStrArray[i], outputFormat);
            }
    ...
    private static String[] convertToTargetPinyinStringArray(char ch,
        ...
        if (null != hanyuPinyinStringArray) {
            ...
            for (int i = 0; i < hanyuPinyinStringArray.length; i++) {
                targetPinyinStringArray[i] = PinyinRomanizationTranslator
                        .convertRomanizationSystem(hanyuPinyinStringArray[i],
    ...
    private static String[] convertToGwoyeuRomatzyhStringArray(char ch) {
        ...
        if (null != hanyuPinyinStringArray) {
            ...
            for (int i = 0; i < hanyuPinyinStringArray.length; i++) {
                targetPinyinStringArray[i] = GwoyeuRomatzyhTranslator
     ...
     * @param outputFormat Describes the desired format of returned Hanyu Pinyin string
     * @param seperater    The string is appended after a Chinese character (excluding
     ...
     *
     * @param ch           The given Unicode character
     * @param outputFormat Describes the desired format of returned Hanyu Pinyin string
    ...
    static private String getFirstHanyuPinyinString(char ch,
                                                    HanyuPinyinOutputFormat outputFormat)
            throws BadHanyuPinyinOutputFormatCombination {
        String[] pinyinStrArray = getFormattedHanyuPinyinStringArray(ch,
                outputFormat);
