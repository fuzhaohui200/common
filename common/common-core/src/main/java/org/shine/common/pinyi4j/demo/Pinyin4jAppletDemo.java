...
package org.shine.common.pinyi4j.demo;

import org.shine.common.pinyi4j.net.sourceforge.pinyin4j.PinyinHelper;
import org.shine.common.pinyi4j.net.sourceforge.pinyin4j.format.HanyuPinyinCaseType;
import org.shine.common.pinyi4j.net.sourceforge.pinyin4j.format.HanyuPinyinOutputFormat;
import org.shine.common.pinyi4j.net.sourceforge.pinyin4j.format.HanyuPinyinToneType;
import org.shine.common.pinyi4j.net.sourceforge.pinyin4j.format.HanyuPinyinVCharType;
import org.shine.common.pinyi4j.net.sourceforge.pinyin4j.format.exception.BadHanyuPinyinOutputFormatCombination;
...
public class Pinyin4jAppletDemo extends JApplet {
    ...
    private JPanel getUnformattedHanyuPinyinPanel() {
        if (unformattedHanyuPinyinPanel == null) {
            ...
            unformattedHanyuPinyinPanel.add(unformattedHanyuPinyinLabel,
                    BorderLayout.NORTH); // Generated
            unformattedHanyuPinyinPanel.add(
                    getUnformattedHanyuPinyinScrollPane(), BorderLayout.CENTER); // Generated
        }
    ...
    private JPanel getUnformattedTongyongPinyinPanel() {
        if (unformattedTongyongPinyinPanel == null) {
            ...
            unformattedTongyongPinyinPanel.add(
                    getUnformattedTongyongPinyinScrollPane(),
    ...
    private JPanel getUnformattedWadePinyinPanel() {
        if (unformattedWadePinyinPanel == null) {
            ...
            unformattedWadePinyinPanel.add(unformattedWadePinyinLabel,
                    java.awt.BorderLayout.NORTH); // Generated
            unformattedWadePinyinPanel.add(
                    getUnformattedWadePinyinScrollPane(), BorderLayout.CENTER); // Generated
        }
    ...
    private JPanel getUnformattedMPS2PinyinPanel() {
        if (unformattedMPS2PinyinPanel == null) {
            ...
            unformattedMPS2PinyinPanel.add(unformattedMPS2PinyinLabel,
                    java.awt.BorderLayout.NORTH); // Generated
            unformattedMPS2PinyinPanel.add(
                    getUnformattedMPS2PinyinScrollPane(), BorderLayout.CENTER); // Generated
        }
    ...
    private JPanel getUnformattedYalePinyinPanel() {
        if (unformattedYalePinyinPanel == null) {
            ...
            unformattedYalePinyinPanel.add(unformattedYalePinyinLabel,
                    java.awt.BorderLayout.NORTH); // Generated
            unformattedYalePinyinPanel.add(
                    getUnformattedYalePinyinScrollPane(), BorderLayout.CENTER); // Generated
        }
    ...
    private JPanel getUnformattedGwoyeuRomatzyhPanel() {
        if (unformattedGwoyeuRomatzyhPanel == null) {
            ...
            unformattedGwoyeuRomatzyhPanel.add(unformattedGwoyeuRomatzyhLabel,
                    java.awt.BorderLayout.NORTH); // Generated
            unformattedGwoyeuRomatzyhPanel.add(
                    getUnformattedGwoyeuRomatzyhScrollPane(),
                    BorderLayout.CENTER); // Generated
        }
    ...
    private JScrollPane getUnformattedMPS2PinyinScrollPane() {
        if (unformattedMPS2PinyinScrollPane == null) {
            ...
            unformattedMPS2PinyinScrollPane
                    .setViewportView(getUnformattedMPS2PinyinTextArea()); // Generated
        }
    ...
    private JScrollPane getUnformattedHanyuPinyinScrollPane() {
        if (unformattedHanyuPinyinScrollPane == null) {
            ...
            unformattedHanyuPinyinScrollPane
                    .setViewportView(getUnformattedHanyuPinyinTextArea()); // Generated
        }
    ...
    private JScrollPane getUnformattedTongyongPinyinScrollPane() {
        if (unformattedTongyongPinyinScrollPane == null) {
            ...
            unformattedTongyongPinyinScrollPane
                    .setViewportView(getUnformattedTongyongPinyinTextArea()); // Generated
        }
    ...
    private JScrollPane getUnformattedWadePinyinScrollPane() {
        if (unformattedWadePinyinScrollPane == null) {
            ...
            unformattedWadePinyinScrollPane
                    .setViewportView(getUnformattedWadePinyinTextArea()); // Generated
        }
    ...
    private JScrollPane getUnformattedYalePinyinScrollPane() {
        if (unformattedYalePinyinScrollPane == null) {
            ...
            unformattedYalePinyinScrollPane
                    .setViewportView(getUnformattedYalePinyinTextArea()); // Generated
        }
    ...
    private JScrollPane getUnformattedGwoyeuRomatzyhScrollPane() {
        if (unformattedGwoyeuRomatzyhScrollPane == null) {
            ...
            unformattedGwoyeuRomatzyhScrollPane
                    .setViewportView(getUnformattedGwoyeuRomatzyhTextArea()); // Generated
        }
    ...
    private JTabbedPane getJTabbedPane() {
        if (jTabbedPane == null) {
            ...
            jTabbedPane.addTab("Unformatted Chinese Romanization Systems",
                    null, getUnformattedCharPanel(), null); // Generated
            jTabbedPane.addTab("Formatted Hanyu Pinyin", null,
                    getFormattedCharPanel(), null); // Generated
        }
        return jTabbedPane;
    }
    ...
    private JPanel getFormattedCharPanel() {
        if (formattedCharPanel == null) {
            ...
            formattedCharPanel.add(getFormattedOutputField(),
                    java.awt.BorderLayout.CENTER); // Generated
        }
            ...
            convertButton
                    .addActionListener(new java.awt.event.ActionListener() {
                        public void actionPerformed(java.awt.event.ActionEvent e) {
                            char chineseCharacter = getChineseCharText()
                                    .charAt(0);

                            updateUnformattedTextField(chineseCharacter);

                            String toneSelection = (String) toneTypesComboBox
                                    .getSelectedItem();
                            String vcharSelection = (String) vCharTypesComboBox
                                    .getSelectedItem();
                            String caseSelection = (String) caseTypesComboBox
                                    .getSelectedItem();

                            updateFormattedTextField(chineseCharacter,
                                    toneSelection, vcharSelection,
                                    caseSelection);
                        }
                         ...
                         */
                        private void updateUnformattedTextField(
                                char chineseCharacter) {
                            unformattedHanyuPinyinTextArea
                                    .setText(concatPinyinStringArray(PinyinHelper
                                            .toHanyuPinyinStringArray(chineseCharacter)));
                            unformattedTongyongPinyinTextArea
                                    .setText(concatPinyinStringArray(PinyinHelper
                                            .toTongyongPinyinStringArray(chineseCharacter)));
                            unformattedWadePinyinTextArea
                                    .setText(concatPinyinStringArray(PinyinHelper
                            ...
                            unformattedGwoyeuRomatzyhTextArea
                                    .setText(concatPinyinStringArray(PinyinHelper
                         ...
                         * @param caseSelection
                         */
                        private void updateFormattedTextField(
                                char chineseCharacter, String toneSelection,
                         ...
                         * @return
                         */
                        private String concatPinyinStringArray(
                                String[] pinyinArray) {
    ...
    private JComboBox getToneTypesComboBox() {
        if (toneTypesComboBox == null) {
            ...
            toneTypesComboBox
                    .addActionListener(new java.awt.event.ActionListener() {
                        public void actionPerformed(java.awt.event.ActionEvent e) {
                            if (toneTypes[2] == (String) toneTypesComboBox
                                    .getSelectedItem()) {
