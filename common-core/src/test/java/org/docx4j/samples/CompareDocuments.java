...
//			= new org.docx4j.convert.out.pdf.viaIText.Conversion(olderPackage);		
        c.output(new FileOutputStream(new File("D:\text.docx")), new PdfSettings());
    ...
    private static void handleRels(Differencer pd, RelationshipsPart rp) {
        ...
        //  and export xslt makes Image internal, though it does avoid duplicating
        //  a part ),
        // remove any existing rels which point to Image
